    ...
    <div className="main-container">
      ...
      <div name="about" className="about section">
        ...
        <div className="inline-content">
          ...
          <p>Lava Gel is a privately held company based in Las Vegas, NV.  We’re comprised of a diverse
            group of ambitious scientists, manufacturers, marketers, and industry veterans who
            are all dedicated to using mineral energy to transform the world we live in. 
            We believe bringing a safe, reliable heating source to everyday applications,
            from medical devices to food and beverage and everything in between is long overdue. It’s this challenge that drives us every day.  And we wouldn’t have it any other way.</p>
        </div>
      </div>
